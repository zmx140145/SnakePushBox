...
public class CameraController : MonoBehaviour {
	...
	void Update () {
        ...
        this.GetComponentInChildren<Camera>().fieldOfView -= Input.mouseScrollDelta.y * zoomSpeed;
        this.GetComponentInChildren<Camera>().fieldOfView = Mathf.Clamp(this.GetComponentInChildren<Camera>().fieldOfView,zoomLimit.x,zoomLimit.y);
